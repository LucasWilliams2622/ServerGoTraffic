...
const loginAdmin = async (username, password) => {
  try {
    return await UserService.loginAdmin(username, password);
  } catch (error) {
    return false;
  }
};
...
const register = async (name, phone, email, password) => {
  try {
    return await UserService.register(name, phone, email, password);
  } catch (error) {
    return false;
  }
};
...
const verifyDriverLicense = async (id) => {
  try {
    return await UserService.verifyDriverLicense(id);
  } catch (error) {
    return false;
  }
};
...
const verifyCode = async (email, verifyCode) => {
  try {
    ...
    if (user) {
      if (user.verificationCodeMail == parseInt(verifyCode)) {
        await db.users.update(
...
const rechargeByIdUser = async (idUser, amount) => {
  try {
    return await UserService.rechargeByIdUser(idUser, amount);
  } catch (error) {
    return false;
  }
};
...
const disableAccount = async (idUser, isActive) => {
  try {
    return await UserService.disableAccount(idUser, isActive);
  } catch (error) {
    return false;
  }
};
...
const checkMail = async (email) => {
  try {
    return await UserService.checkMail(email);
  } catch (error) {
    return false;
  }
};
...
const checkPhone = async (phone) => {
  try {
    return await UserService.checkPhone(phone);
  } catch (error) {
    return false;
  }
};
